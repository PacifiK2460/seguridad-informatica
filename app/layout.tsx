      ...
      >
        <ThemeProvider attribute="class">
          <Theme accentColor="red" grayColor="mauve" radius="none">
            <Toaster richColors />
            <Flex direction="column" align="center" justify="center" className="w-[100dvw] h-full">
              <Grid columns={
                {
                  initial: "1",
                  lg: "2",
                }
              } gap="5" align="center" justify="between" className="minh-[100dvh] lg:h-[100dvh]" py={{
                initial: "0",
                lg: "5",
              }}>
                <Flex style={{ position: 'relative' }} className="h-screen lg:h-full overflow-hidden">
                  ...
                  />
                  <Flex direction="column" justify="between" style={{ position: 'relative', zIndex: 1, width: '100%', height: '100%' }}
                  >
              ...
              <Separator className="min-w-[80dwh]" />
              ...
              } gap="5" align="center" justify="between" className="min-h-screen min-w-screen lg:h-screen" py={{
                initial: "0",
                lg: "5",
              }}>
